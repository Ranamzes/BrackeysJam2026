...
func start_dialogue(resource: DialogueResource, title: String, extra_game_states: Array = [], portrait_texture: Texture2D = null) -> void:
	...
	current_dialogue_ui.start(resource, title, extra_game_states, portrait_texture)
